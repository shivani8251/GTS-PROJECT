...
<head>
  ...
  <meta name="author" content="The Vestra">
    <title>Edit List Institute GTS</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h6 class="float-left mb-1">Edit Institute Detail</h6>
                <div class="float-right">
                  <a href="{{ route('institute') }}" class="btn btn-sm btn-primary"><i class="bx bx-left-arrow-alt"></i> Back</a>
                </div>
              </div>
              <div class="card-body">
                <form method="post" id="edit_institute_form" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Institute Name" autocomplete="off" name="Institute_name" id="Institute_name" value="{{$data->ins_name}}" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <select data-placeholder="Select Country" name="country_name[]" id="country_name[]" class="form-control select2" multiple>
                          <option value="">--Select--</option>
                           ...
                           @php 
                            ...
                            $ccid = explode(',', $data->country_id);

                          @endphp

                          @foreach($country as $C)
                           @if(in_array($C->id, $ccid))
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="number" placeholder="Institute Rank" autocomplete="off" name="rank" id="rank" value="{{$data->rank}}" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-9 col-xs-9">
                      <div class="form-group">
                        ...
                        <input type="number" placeholder="UG And PG Fee" autocomplete="off" name="ug_pg_fee" id="ug_pg_fee" value="{{$data->ug_pg_fee}}" class="form-control" required>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="ug_fee_type" id="ug_fee_type" class="form-control select2" required>
                            <option value="" disabled>Fee Type</option>
                             ...
                             @if($data->ug_fee_type == 'INR')
                          <option value="INR" selected>INR</option>
                          @else
                          <option value="INR">INR</option>
                          @endif
                          @if($data->ug_fee_type == 'GBP')
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-9 col-xs-9">
                      <div class="form-group">
                        ...
                        <input type="number" placeholder="Cost Of Living" autocomplete="off" name="cost_live" id="cost_live" value="{{$data->cost_live}}" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <select name="cost_type" id="cost_type" class="form-control select2" required>
                          ...
                          @if($data->cost_type == 'INR')
                          <option value="INR" selected>INR</option>
                          @else
                          <option value="INR">INR</option>
                          @endif
                          @if($data->cost_type == 'GBP')
                          <option value="GBP" selected>GBP</option>
                          @else
                          <option value="GBP">GBP</option>
                          @endif
                      ...
                      <div class="form-group">
                        ...
                        <select name="accommodation" id="accommodation" class="form-control select2" required>
                            <option value="" disabled>Type of Accommodation</option>
                             @if($data->accommodation == 'Rent')
                          <option value="Rent" selected>Rent</option>
                          @else
                          <option value="Rent">Rent</option>
                          @endif
                           @if($data->accommodation == 'Flat')
                      ...
                      <div class="form-group">
                        ...
                        <select name="type_institute" id="type_institute" class="form-control select2" required>
                            <option value="" disabled>Type of institute</option>
                             @if($data->type_institute == 'Public')
                          <option value="Public" selected>Public</option>
                          @else
                          <option value="Public">Public</option>
                          @endif
                           @if($data->type_institute == 'Private')
                          <option value="Private" selected>Private</option>
                          @else
                          <option value="Private">Private</option>
                          @endif
                           @if($data->type_institute == 'Scholarship')
                   ...
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <input type="number" placeholder="Foundation Year" autocomplete="off" name="found_year" id="found_year" value="{{$data->found_year}}" class="form-control" required>
                      </div>
                    </div>
...
let myForm = document.getElementById('edit_institute_form');
