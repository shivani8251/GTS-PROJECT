                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="float-right">
                      <a href="{{ route('course.add') }}" class="btn btn-sm btn-primary"><i class="bx bx-plus"></i>Add</a>
                    </div>
                      ...
                      <table class="table table-striped table-bordered w-100" id="Ins-course-table">
                        <thead>
                          <tr>
                           ...
                           <th>Course Type</th>
                           <th>Course Level</th>
                            <th>Tuition  Cost Fees</th>
                           <th>Living Cost Fees</th>
  ...
  <script>
    ...
    function InsListTable() {
      ...
      $("#Ins-course-table").DataTable({
        ...
        order: [],
        ajax: {
            url: "{{ route('courselisttableTable') }}",
            type: "GET",
            data: {}
        },
             "columns": [
     ...
     $(document).on('click', '.deactivate-course-btn', function() {
      ...
      $(document).on('click', '.activate-course-btn', function() {
        let id = $(this).data('id');
        $.confirm({
            title: 'Confirm!',
            type: 'red',
