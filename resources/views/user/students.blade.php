...
<title>Students || GTS Overseas</title>
<style>
  .dlab-bnr-inr h1{
        color: #1f2471;
    }
        ...
        <div id="__next">
            <div class="page-wraper">
                <div class="page-content bg-white">
                    ...
                    <div class="dlab-bnr-inr style-1 " style="background-image: url(public/user-assets/images/student-recruitment/student-top-map.svg); background-size: auto; background-repeat: no-repeat; ">

                        <div class="container">
                            <div class="dlab-bnr-inr-entry">
                                <h1>Reach your Dream College Abroad without hassle</h1>
                                <h4>GeeBee helps you every step of the way- starting from test preparation to finding the right universities and applying for a visa. With our 20+ years of experience and 750+ strong university network, getting into your dream college is super easy!</h4>
                                <nav aria-label="breadcrumb" class="breadcrumb-row style-1">
                                    <ul class="breadcrumb" style="background-image: none; display:inline-flex; ">
                                        <li class="breadcrumb-item"><a href="http://gtsoverseas.programmics.tech/students#contact-form" class="input-group-addon m-t20"><button name="submit" value="Submit" type="submit" class="float-right btn btn-corner gradient shadow btn-primary">Start your journey</button></a></li>
                                        <li class="breadcrumb-item"><a href="/course_search" class="input-group-addon m-t20"><button name="submit" value="Submit" type="submit" class="float-right btn btn-corner gradient shadow btn-primary">Find your Course</button>
                                        </a></li> 
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <section class="content-inner">
                        <div class="container">
                            <div class="section-head style-3 text-center mb-4">
                                <h2 class="title">How GTSoverseas helps students</h2>
                                <div class="dlab-separator style-2 bg-primary"></div>
                            </div>
                            <div class="row icon-container">
                                <!-- <div class="timeline_progress-bar-wrapper"></div> -->
                            <img src="{{ asset('public/user-assets/images/student-recruitment/line.svg') }}" class="progr-ress-bar" alt=""/>
                                <div class="icon-bx-wraper style-5 binashadow text-center m-b30">
                                    <div class="icon-bx">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <h4 class="dlab-title m-b15">100+ Counsellors </h4>
                                ...
                                <div class="icon-bx-wraper style-5 binashadow text-center m-b30">
                                    ...
                                    <div class="icon-content">
                                        <!-- <h6 class="sub-title text-primary m-b10">Step 1</h6> -->
                                        <h4 class="dlab-title m-b15">Test Preparations </h4>
                                        {{--  <p class="m-b20">Complete a short survey and get matched to programs and schools.</p> --}}
                                        <!-- <a class="btn btn-outline-primary" href="services-3"><i class="fa fa-angle-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="icon-bx-wraper style-5 binashadow text-center m-b30">
                                    ...
                                    <div class="icon-content">
                                        <!-- <h6 class="sub-title text-primary m-b10">Step 1</h6> -->
                                        <h4 class="dlab-title m-b15">Live Seminars </h4>
                                        {{--  <p class="m-b20">Complete a short survey and get matched to programs and schools.</p> --}}
                                        <!-- <a class="btn btn-outline-primary" href="services-3"><i class="fa fa-angle-right"></i></a> -->
                                    </div>
                                </div>
                                <div class="icon-bx-wraper style-5 binashadow text-center m-b30">
                                    ...
                                    <div class="icon-content">
                                        <!-- <h6 class="sub-title text-primary m-b10">Step 1</h6> -->
                                        <h4 class="dlab-title m-b15">Access to 750+<br>Universities </h4>
                                        {{--  <p class="m-b20">Complete a short survey and get matched to programs and schools.</p> --}}
                                        <!-- <a class="btn btn-outline-primary" href="services-3"><i class="fa fa-angle-right"></i></a> -->
                                    </div>
                                </div>
                            </div>
                            <!-- <a href="/search_univercity" class="input-group-addon m-t20"><button name="submit" value="Submit" type="submit" class="float-right btn btn-corner gradient shadow btn-primary">Search University</button>
                                </a> &emsp; -->
                            {{-- <a href="/course_search" class="input-group-addon m-t20"><button name="submit" value="Submit" type="submit" class="float-right btn btn-corner gradient shadow btn-primary">Find your Course</button>
                                </a> --}}
                        </div>
                    </section>
                    ...
                    <section class="content-inner">
                        <div class="container">
                            <div class="section-head style-3 text-center mb-5">
                                <h2 class="title">The fastest, most convenient way to study abroad</h2>
                                <div class="dlab-separator style-2 bg-primary"></div>
                            </div>
                            <div class="row">
                    ...
                    <section class="content-inner">
                        <div class="container">
                            <div class="section-head style-3 text-center mb-4">
                                <h2 class="title">Our Top Partner Universities</h2>
                                <div class="dlab-separator style-2 bg-primary"></div>
                            </div>
                            <div class="row">
                    ...
                    <section
                        class="content-inner-3 wow fadeIn" id="contact-form"
