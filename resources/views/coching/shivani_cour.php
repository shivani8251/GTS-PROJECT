...
button {
    ...
    <body>
                            ...
                            <div class="dlab-bnr-inr-entry">
                                ...
                                <nav aria-label="breadcrumb" class="breadcrumb-row style-1">
                                  ...
                                  <div>
                                    ...
                                    <input type="Search" name="course_uni_search" placeholder="Search Course and University">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xl-9 col-lg-8" style="padding-left: 22px;">
                                    ...
                                    <div class="row">
                                        @if(!empty($course_uni_search_data))
                                          

                                 
                              @foreach($course_uni_search_data as $ins_lists)
                              @if ($ins_lists->tag_cour =='course')
                                                ...
                                                <div class="col-lg-5 wow fadeIn row carda" style=" margin-left:initial;" data-wow-duration="2s" data-wow-delay="0.2s">
                                                   <h5>{{$ins_lists->course }}</h5> 
                                                    <table class="cou" style="border-spacing: 10px;">
                                                        ...
                                                        <tr>
                                                            <td>{{ $ins_lists->duration }}</td>
                                                            <td> {{$ins_lists->tuition_fee }} INR</td>
                                                            <td>{{ $ins_lists->c_type }}</td>
                                                        </tr>
                                                    </table>
                                                    <a class="btn btn-outline-primary" style="width: 160px;" data-toggle="modal" data-target="#exampleModal{{ $ins_lists->id }}">Apply Now&ensp;</span><i class="fa fa-angle-right"></i></a>
                                                                ...
                                                                <form class="" method="POST" id="contact" action="">
                                                                      ...
                                                                      <div class="row">
                                                                         ...
                                                                         <div class="col-sm-12">
                                                                          ...
                                                                          <div class="col-sm-12">
                                                                        <label>For Applying Courses:- {{ $ins_lists->course }}
                           ...
                           <div class="row">
                                        ...
                                        @foreach($course_uni_search_data as $u)
                                         @elseif($u->tag_ins == 'institute')
      ...
      return "this course and this university are not available"
