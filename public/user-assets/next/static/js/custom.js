		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.site-header .container > .logo-header .logo').attr('src','xhtml/images/logo.png');
					$('.site-header .container > .logo-header .logo-2').attr('src','xhtml/images/logo-2.png');
					$('.site-header .container > .logo-header .logo-3').attr('src','xhtml/images/logo-3.png');
				} else {
					menu.removeClass('is-fixed');
					$('.site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3').attr('src','xhtml/images/logo-white.png')
				}
			}
		});
