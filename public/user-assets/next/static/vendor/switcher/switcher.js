function addSwitcher()
{
	...
	var dzSwitcher = '<div id="dzSwitcher-right" class="styleswitcher"><div class="switcher-btn-bx"><a href="javascript:void(0);" class="switch-btn closed"> <span class="fa fa-cogs fa-lg"></span></a></div><div class="styleswitcher-inner"> <a href="javascript:void(0);" class="dez-page btn btn-primary btn-sm" onclick="deleteAllCookie();">Delete All Cookie</a><div class="theme-box"><h5 class="switcher-title"><span>Theme</span></h5><h6 class="switcher-title">Standard</h6><ul val="themeFullColor" class="color-skins-db theme-panel-save"><li><a class="theme-skin skin-1" href="#" dir="css/skin/skin-1" logo="xhtml/images/logo.png"></a></li><li><a class="theme-skin skin-2" href="#" dir="css/skin/skin-2" logo="xhtml/images/logo-2.png"></a></li><li><a class="theme-skin skin-3" href="#" dir="css/skin/skin-3" logo="xhtml/images/logo-3.png"></a></li></ul></div><div class="theme-box"><h5 class="switcher-title"><span>Layout</span></h5><ul val="layout" class="layout-view theme-panel-save"><li class="wide-layout active"><a href="#" dir="wide-layout">Wide</a></li><li class="boxed"><a href="#" dir="boxed">Boxed</a></li><li class="frame"><a href="#" dir="frame">Frame</a></li></ul><div id="ThemeRangeSlider" class="price-slide-2 range-slider" style="display:none"><div class="price"> <input type="text" id="FramePadding" class="amount" readonly="" value="20px" /><div id="slider-range-3"></div></div></div></div><div class="theme-box"><h5 class="switcher-title"><span>Header</span></h5><ul val="header" class="header-view theme-panel-save"><li class="header-fixed active"><a href="#" dir="sticky-header">Fixed</a></li><li class="header-static"><a href="#" dir="sticky-no">Static</a></li></ul></div><div class="theme-box"><h5 class="switcher-title"><span>Background</span></h5><h6 class="switcher-title">Color</h6><ul val="bgColor" class="bg-color-switcher theme-panel-save"><li><a class="bg-color-1" href="#" dir="#896eff"></a></li><li><a class="bg-color-2" href="#" dir="#f55f8d"></a></li><li><a class="bg-color-3" href="#" dir="#ef146e"></a></li></ul><h6 class="switcher-title">Image</h6><ul val="bgImage" class="background-switcher theme-panel-save"><li><img src="xhtml/images/switcher/switcher-bg/bg1.jpg" dir="xhtml/images/background/bg1.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-bg/bg2.jpg" dir="xhtml/images/background/bg2.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-bg/bg3.jpg" dir="xhtml/images/background/bg3.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-bg/bg4.jpg" dir="xhtml/images/background/bg4.jpg" alt=""></li></ul><h6 class="switcher-title">Pattern</h6><ul val="bgPatten" class="pattern-switcher theme-panel-save"><li><img src="xhtml/images/switcher/switcher-patterns/bg1.jpg" dir="xhtml/images/pattern/pt1.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg2.jpg" dir="xhtml/images/pattern/pt2.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg3.jpg" dir="xhtml/images/pattern/pt3.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg4.jpg" dir="xhtml/images/pattern/pt4.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg5.jpg" dir="xhtml/images/pattern/pt5.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg6.jpg" dir="xhtml/images/pattern/pt6.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg7.jpg" dir="xhtml/images/pattern/pt7.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg8.jpg" dir="xhtml/images/pattern/pt8.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg9.jpg" dir="xhtml/images/pattern/pt9.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg10.jpg" dir="xhtml/images/pattern/pt10.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg11.jpg" dir="xhtml/images/pattern/pt11.jpg" alt=""></li><li><img src="xhtml/images/switcher/switcher-patterns/bg12.jpg" dir="xhtml/images/pattern/pt12.jpg" alt=""></li></ul></div></div></div>';
...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-dark img").attr("src", "xhtml/images/logo.png");
		jQuery(".logo-white img").attr("src", "xhtml/images/logo-white.png");
		
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "../../css/skin/skin-2.css");
		jQuery(".logo-dark img").attr("src", "xhtml/images/logo-2.png");
		jQuery(".logo-white img").attr("src", "xhtml/images/logo-white-2.png");
        return false;
    });
   
    jQuery(".skin-3").on('click',function(){
        jQuery(".skin").attr("href", "../../css/skin/skin-3.css");
		jQuery(".logo-dark img").attr("src", "xhtml/images/logo-3.png");
		jQuery(".logo-white img").attr("src", "xhtml/images/logo-white-3.png");
        return false;
    });
